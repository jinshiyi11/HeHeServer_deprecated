...
public class VideoCrawler {
	...
	public VideoCrawler(String startUrl, ICrawlerCallback callback) {
		mStartUrl = startUrl;
		...
		try {
			...
			for (Element element : items) {
				try {
					...
					if (info.mFlashVideoUrl == null
							|| info.mWebVideoUrl == null) {
						// TODO:LOG
					...
					/*
					 * <div style=
					 * "background-image: url('http://v3.pfs.56img.com/images/26/24/jasperci56olo56i56.com_sc_13902076340hd.jpg')"
					 * class="video"> <a
					 * href="http://share.renren.com/share/406776768/16865052333"
					 * target="_blank"
					 * onclick="shareLog('list', 'click', 3)">播放</a> </div>
					 */
					...
					mCrawlerCallback.addVideo(info);
