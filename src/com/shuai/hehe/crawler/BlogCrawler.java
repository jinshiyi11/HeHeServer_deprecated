...
public class BlogCrawler {
	...
	public BlogCrawler(String startUrl, ICrawlerCallback callback) {
		mStartUrl = startUrl;
	 ...
	 * @throws IOException
	 */
	private String getBlogContent(String url, CrawlerBlogInfo info) throws IOException {
